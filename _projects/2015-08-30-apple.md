...
description: Apple works hard cranking out products for their consumers but internal employees do not get the same level of attention. The support teams are in need of new tools to overcome the onslaught of inquiries for which they have to respond. 
featured_image: '/images/header-apple.jpg'
poster: '/images/poster-apple.png'
link_previous: anomalie.html
link_next: paypal.html
accent_color: '#4C60E6'
gallery_images:
  - demo.jpg
  - demo.jpg
...
<td><i class="fas fa-angle-double-down"></i> &nbsp;<a href="https://www.screenplay.design/project/apple.html#spoilers" target="_self">Jump to spoilers</a> </td>
...
<img src="../images/story-apple-6.png">
  ...
  <div class="wrap grid">
    ...
    <div class="about__content">
      ...
      <p>Iterating off the whiteboard, I applied the conversation and past research into how the user flows would look for specific use cases. I like to also put them side by side for different types of users so I can find some overall patterns.</p>
...
> <h3>Was it helpful?</h3> The Apple customer support team was very grateful for the attention to their needs and requested me to join a new initiative to take the project to the next level 6 months later. Alas, I was already occupied on another role but grateful for the ask.
