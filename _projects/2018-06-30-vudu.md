---
title: 'Strategies for a Better Leisuretime'
subtitle: 
date: 2018-06-30 00:00:00
description: The new world order of entertainment is that everyone can’t keep up with all the media being delivered. It can be daunting to even know where to find your favorites much less discover something new. There must be a way to help people manage this overload.
featured_image: '/images/header-vudu.jpg'
poster: '/images/poster-vudu.png'
...
<td><img src="../images/story-poster-vudu.png"></td>
<td><a href="walmart.html"><i class="fas fa-chevron-right"></i></a></td>
...
<td><i class="fas fa-angle-double-down"></i> &nbsp;<a href="https://www.screenplay.design/project/vudu.html#spoilers" target="_self">Jump to spoilers</a> </td>
...
> <h3>Was it helpful?</h3> Now that I have a concept in place, I'd love to actually use the project to practice building a mobile application. In the meantime, I will also test with more users to see if the concept has traction. Who knows, it may even end up hitting the app store one day.
